class Admin::ContextsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @context.update(context_params)
        format.html { redirect_to admin_contexts_url(), notice: "Context was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_contexts_url, notice: "Context was successfully destroyed." }
